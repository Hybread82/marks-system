...
<head>
    ...
    <title>Mount Kenya University - Lecturer Login</title>
...
<body>
    ...
    <div class="login-card animate-slide">
        ...
        <h4 class="text-center mb-3">👨‍🏫 Lecturer Login</h4>
        ...
        <form method="POST">
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control" placeholder="lecturer@mku.ac.ke" required>
            </div>
            <div class="mb-3">
